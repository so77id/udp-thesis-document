...
Antes de poder realizar la extracción de características de los vídeos, es necesario realizar un preprocesamiento sobre estos, esto debido a que los vídeos que se utilizan para realizar las pruebas del algoritmo pueden tener ciertos elementos que molesten. Para evitar agregar ruido al vídeo se utilizan dos técnicas que permiten obtener solo el rostro de la persona a representar su expresión y a su vez corregir los movimientos que estos puedan tener. Esta etapa sera profundizada en la Sección~\ref{sec:proc_bdd}.
