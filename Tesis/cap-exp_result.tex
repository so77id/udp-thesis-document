...
Por último como experimento final decidimos realizar una comparación del \textit{Accuracy} obtenido con mejores valores de las variables del algoritmo ($RS$, $WS$, $N$, $K$). Esta comparación puede ser visualizada en la Tabla~\ref{tabla:exp:accuracy}.
